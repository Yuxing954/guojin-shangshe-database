(function(root,factory){
  ...
  return{MARKETS:MARKETS,marketOf:marketOf,quoteCode:quoteCode,calendarDate:calendarDate,tradingDate:tradingDate,rowDate:rowDate,latestSession:latestSession,normalize:normalize,sanitizeIntraday:sanitizeIntraday,checkRollover:checkRollover,onTradingDayChange:onTradingDayChange,clearIntraday:clearIntraday,getIntradayCache:getIntradayCache,setIntradayCache:setIntradayCache};
});
